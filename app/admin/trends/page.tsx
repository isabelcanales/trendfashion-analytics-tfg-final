  ...
  return (
    <main className="min-h-screen bg-[#fffdf9] p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold text-[#151111] mb-4">Gestión de Tendencias</h1>
        <p className="text-[#b8a9a6] text-lg mb-8">
          Administra las tendencias de moda, crea nuevos análisis y configura predicciones temporales.
        </p>
