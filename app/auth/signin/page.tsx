            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder=""
                  className="w-full px-4 py-2 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8a2638]"
                  disabled={isLoading}
                />
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#8a2638] transition"
                  aria-label={
